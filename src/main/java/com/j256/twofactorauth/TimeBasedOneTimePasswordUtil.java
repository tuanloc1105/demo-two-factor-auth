...
public class TimeBasedOneTimePasswordUtil {
	...
	/**
	 * Similar to {@link #validateCurrentNumber(String, int, long, long, int, int)} except exposes other parameters. Mostly for testing.
	 * 
	 * @param base32Secret
	 *            Secret string encoded using base-32 that was used to generate the QR code or shared with the user.
	 * @param authNumber
	...
	/**
	 * Similar to {@link #validateCurrentNumberHex(String, int, long, long, int, int)} except exposes other parameters. Mostly for
	 * testing.
	 * 
	 * @param hexSecret
	 *            Secret string encoded in hexadecimal that was used to generate the QR code or shared with the user.
